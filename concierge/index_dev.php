...
<div class="concierge-splash">
  ...
  <tbody>
    <tr>
      <td><a href="concierge-checkout.php" class="cta tada animated" role="button" style="width:180px">PLANS & PRICING</a></td>
     </tr>
     <tr> 
		...
		<div class="content">
			<div class="desc">
				...
				<h3 style="margin-left:80px">
					...
					<img src="images/splash/conciere-text-icon.png"/>Branded Content Catered to Your <br />
					<span style="margin-left:35px">Audience</span><br/>
					<img src="images/splash/conciere-text-icon.png"/>Choose from Numerous  <br />
					<span style="margin-left:35px">Categorides That fit You Lifestyle</span><br/>
					...
					<span style="margin-left:270px"><img src="images/splash/concierge-social.png" /></span>
				</h3>
			</div>
			<div class="icons">
