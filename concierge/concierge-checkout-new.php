...
//=======================================================================
	...
	$header = '
<script src="js/checkout_1.js?randIt='.$homeRandNum.'"></script>
<link href="https://fonts.googleapis.com/css?family=Nunito:300" rel="stylesheet" type="text/css">
<link href="https://fonts.googleapis.com/css?family=Lato:100" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/concierge-checkout_1.css?randIt='.$homeRandNum.'"/>
';
...
<script>
	...
	<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/866348525/?label=GQIVCJ_b1mwQ7duNnQM&amp;guid=ON&amp;script=0"/>
	</div>
</noscript>
<?php	
...
?>
	<div class="concierge-set-up">
        ...
        <center class="platinum-package">
			<img src="images/platinum.png" alt="Concierge for Brokerages" />
            <div class="brokerage-quote-button" onclick="choseAgentBroker()">Get a Quote</div>
			<div class="video-bio-button"  onclick="showVideo('http://www.spotlighthometours.com/tours/video-player.php?type=video&id=1133991&autoPlay=true')">Demo</div>
			<div class="logo-amination-button"  onclick="showVideo('http://www.spotlighthometours.com/tours/video-player.php?type=video&id= 2574577&autoPlay=true')">Demo</div>
			<div class="book-end-button"  onclick="showVideo('http://www.spotlighthometours.com/tours/video-player.php?type=video&id=2573572&autoPlay=true')">Demo</div>
			<div class="realtor-website-button"  onclick="agentWebsite('http://www.spotlighthometours.com/microsites/agent.php')">Demo</div>
			<!-- <div class="realtor-website-button"><a href="http://www.spotlighthometours.com/microsites/agent.php" class="demo-realtor-website" target="_new">Demo</a></div> -->
		</center>
		
        <!-- Popup Videos -->
		<div class="popup-video"><iframe src="" width="900" height="507" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
		...
		<table cellpadding="17" cellspacing="0" class="packages" id="packages" style="margin-left:10px;">
            ...
            <tr>
				<td valign="top" align="center">
					...
					<div class="package-price" id="package-price" data-choice="Bronze Concierge Monthly Subscription" data-type="month" data-membershipid="7" >$<?PHP echo $bronzeMonthlyPrice ?> / Monthly</div>
					<div class="package-price" data-choice="Bronze Concierge Yearly Subscription" data-type="year" data-membershipid="7" >$<?PHP echo $bronzeYearlyPrice ?> / Yearly</div>
				</td>
				<td valign="top" align="center">
					<img src="images/silver.png" alt="Silver" />
					<div class="package-price" data-choice="Silver Concierge Monthly Subscription" data-type="month" data-membershipid="6" >$<?PHP echo $silverMonthlyPrice ?> / Monthly</div>
					<div class="package-price" data-choice="Silver Concierge Yearly Subscription" data-type="year" data-membershipid="6">$<?PHP echo $silverYearlyPrice ?> / Yearly</div>
				</td>
				<td valign="top" align="center">
                
					<!-- <a href="http://www.spotlighthometours.com/microsites/agent.php" class="demo-realtor-website" target="_new"></a> -->
					...
					<div class="package-price" data-choice="Gold Concierge Monthly Subscription" data-type="month" data-membershipid="5">$<?PHP echo $goldMonthlyPrice ?> / Monthly</div>
					<div class="package-price" data-choice="Gold Concierge Yearly Subscription" data-type="year" data-membershipid="5">$<?PHP echo $goldYearlyPrice ?> / Yearly</div>
				</td>
			</tr>
		</table>
		<center>
			<br/><img src="images/concierge-for-brokerages.png" alt="Concierge for Brokerages" width="277" height="40" border="0" /><br/>
			<div class="brokerage-quote" onclick="getQuoteForm()" style="width:100px;">Get a Quote</div>
		</center>
		...
		<div id="billing">
			...
			<form>
				...
				<div  id="cvv">
					...
					<input type="text" maxlength="3" name="credit_cvv" id="credit_cvv"/>
				</div>
				<div  id="address">
