...
//=======================================================================
	...
	$header = '
<script src="js/checkout_1.js"></script>
<link href="https://fonts.googleapis.com/css?family=Nunito:300" rel="stylesheet" type="text/css">
<link href="https://fonts.googleapis.com/css?family=Lato:100" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/concierge-checkout_1.css"/>
';
...
?>
	<div class="concierge-set-up">
        ...
        <center class="platinum-package">
            ...
            <a class="brokerage-quote-button" onclick="choseAgentBroker()" style="width:110px;">Request a Demo</a>
			<a class="video-bio-button"  onclick="showVideo('https://www.spotlighthometours.com/tours/video-player.php?type=video&id=1133991&autoPlay=true')">Demo</a>
			<a class="logo-amination-button"  onclick="showVideo('https://www.spotlighthometours.com/tours/video-player.php?type=video&id= 2574577&autoPlay=true')">Demo</a>
			<a class="book-end-button"  onclick="showVideo('https://www.spotlighthometours.com/tours/video-player.php?type=video&id=2573572&autoPlay=true')">Demo</a>
			<a class="realtor-website-button"  onclick="agentWebsite('https://www.spotlighthometours.com/microsites/agent.php')">Demo</a>
		...
		<table cellpadding="17" cellspacing="0" class="packages" id="packages" style="margin-left:10px;">
            ...
            <tr>
			  <td valign="top" align="center">
					<input id="userid" name="userid" type="hidden" value="<?php echo ($userID > 0 ? $userID: 0); ?>" />
			  ...
			  <td valign="top" align="center">
			    ...
			    <div class="realtor-website-button2"  onclick="agentWebsite('http://www.spotlighthometours.com/microsites/agent.php?userID=15')">Demo</div>
		...
		<center>
			...
			<a class="brokerage-quote" onclick="getQuoteForm()" style="width:110px;">Request a Demo</a>
		  ...
		  or <br> call us at <strong>(801) 466.4074</strong></div>
		</center>
