  ...
  <tbody>
	...
	<div class="social-hub">
		<div class="content">
			<div class="desc">
				<h2>Social Hub</h2>
				<h3>Simplify Your Online Presence</h3>
				Social Hub lets you communicate <br />
			and manage each one of your social <br />
			network accounts with one simple <br />
			tool. </div>
			<div class="icons">
				<img src="images/splash/social-hub-circle.png" />
			</div>
			<div class="clear"></div>
		</div>
	</div>
		...
		<div class="content">
			...
			<div class="row1">
				...
				<div class="feature">
					...
					Create and send email blasts to all of your clients
				</div>
				<div class="feature">
