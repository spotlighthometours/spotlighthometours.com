...
function Coupon(){
    ...
    try {
        ...
        //var url = "Membership_functions.php";
        ...
        $.ajax({
            url     : "membership_functions.php?view=applyCoupon",
            type    : "POST",
            data    : params,
            success : function(data){
            	HideWait();
                //console.log(data);
                var coupon_td = $("td.membership_coupon");
                var total = $("#total");
        ...
        window.alert("PopulatemembershipCheckout: " + err + ' (line: ' + err.line + ')');
    }
}
...
function Validatemembership(id) {
	"user strict";
    try {
		...
		window.alert("Validatemembership: " + err + ' (line: ' + err.line + ')');
	}
}
...
function SubmitOrder(id) {
    ...
    try{
        ...
        $.ajax({
            url :   "membership_functions.php?view=submitOrder",
            type :  "POST",
            data :  params,
            success: function(data){
                //console.log(data);
...
function GetCompleteScreen() {
	var membershipName = order.membershiptype;
	$.ajax({
		url :   "membership_modal.php",
         type :  "POST", 
		 data :  membershipName,        
         success: function(data){
         	complete = data;
