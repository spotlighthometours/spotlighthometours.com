...
<html>
        <head>
        <title>Low Res Photo Downloads</title>
        ...
        <script>
			...
			$(document).ready(
				function() {
                    if(isIE () && isIE () < 9){
                        window.location="http://www.spotlighthometours.com/image_processor/get_photos.php?tourid=<?php echo intval($_REQUEST['id']) ?>&w=640&h=480&download=1";
                    }
                    else
                    {
                        ...
                        $.fileDownload('http://www.spotlighthometours.com/image_processor/get_photos.php?tourid=<?php echo intval($_REQUEST['id']) ?>&w=640&h=480&download=1', {
...
<b>Your files have been archived.</b> We are retrieving your files from an archive. Please allow a couple of minutes to download. The more photos in your tour, the longer the wait. Please be patient. Downloads may take as much as <b>10-15</b> minutes to download.
                We are preparing your low resolution photos download. Our server may takes several minutes to prepare your download. Once the download is ready this dialog will change and your download will start, please wait...
                <p align="center"><img src="images/common/loader-bar.gif" /></p>
            </div>
            <div id="error-modal" title="Error" style="display: none;">
                There was a problem generating your low resolution photos download, please try again.
            </div>
            <div id="complete-file-modal" title="Downloading..." style="display: none;">
                Your low resolution photos are downloading, please check your browser's download section for the download progress information and location. You will not be notified by this page when the download completes.
