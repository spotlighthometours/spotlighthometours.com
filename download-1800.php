...
<html>
        <head>
        <title>1800 x 1200 Photo Downloads</title>
        ...
        <script>
			...
			$(document).ready(
				function() {
                    ...
                    if(isIE () && isIE () < 9){
                        window.location="http://www.spotlighthometours.com/image_processor/get_photos.php?tourid=<?PHP echo intval($_REQUEST['id']) ?>&w=1800&h=1200&download=1";
                    }
                    else {
                        ...
                        $.fileDownload('http://www.spotlighthometours.com/image_processor/get_photos.php?tourid=<?PHP echo intval($_REQUEST['id']) ?>&w=1800&h=1200&download=1', {
        ...
        <body>
            ...
            <div id="complete-file-modal" title="Downloading..." style="display: none; width:auto;">
                Your photos are downloading, please check your browser's download section for the download progress information and location. You will not be notified by this page when the download completes.
