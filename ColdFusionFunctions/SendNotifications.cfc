<cfcomponent>
    ...
    <CFARGUMENT name="brokerid" type="string" required="No">
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    ...
    <cfhttpparam type="formfield" name="type" value="scheduleattempt"> 
    ...
    <cfhttpparam type="formfield" name="subject" value="Spotlight Schedule Attempt: #qTours.address#">
</cfhttp>  
            </CFCASE>
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    ...
    <cfhttpparam type="formfield" name="subject" value="Spotlight Appointment Confirmation: #qTours.address#">
            ...
            <cfset hashString = generateFetchUserHash(userID=#qUser.userID#) />
         	<cfsavecontent variable="mailText">
                    <cfoutput>
<p>
...
<p>
We are pleased to inform you that your virtual tour for <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#</strong>  with the #qTours.tourTypeN# package is online and available for viewing by clicking the link below:
</p>
<p>
BRANDED TOUR LINK:<br/>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#<br/>
<br/>
NON BRANDED TOUR LINK (use this one on your MLS)<br/>
http://www.spotlighthometours.com/tours/tour.php?tourid=#qTours.tourid#&mlsversion=1
</p>
<p>
If you also ordered a cinematic package with these photos you will receive a second email confirmation when the video is available for viewing. You can also download the <strong>high, medium, or low</strong> resolution images by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the tour as a whole or individual photos for download.</strong>
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    <cfhttpparam type="formfield" name="tourId" value="#arguments.tourid#">
    <cfhttpparam type="formfield" name="type" value="finalized"> 
    <cfhttpparam type="formfield" name="level" value="broker"> 
    <cfhttpparam type="formfield" name="form" value="email"> 
    <cfhttpparam type="formfield" name="to" value="#emailTo#"> 
    <cfhttpparam type="formfield" name="mailText" value="#mailText#">
    <cfhttpparam type="formfield" name="subject" value="Spotlight Tour is ready! #qTours.address#">
</cfhttp> 
			...
			<CFCASE value="reshoot finalized">
            <cfset hashString = generateFetchUserHash(userID=#qUser.userID#) />
         	<cfsavecontent variable="mailText">
                    <cfoutput>
<p>
...
<p>
We are pleased to inform you that your updated virtual tour photos for <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#</strong> have been finished, are online and available for viewing by clicking the link below:
</p>
<p>
BRANDED TOUR LINK:<br/>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#<br/>
...
<p>
You can also download the <strong>high, medium, or low</strong> resolution of your updated images by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the tour as a whole or individual photos for download.</strong>
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    <cfhttpparam type="formfield" name="tourId" value="#arguments.tourid#">
    <cfhttpparam type="formfield" name="type" value="reshoot finalized"> 
    <cfhttpparam type="formfield" name="level" value="broker"> 
    <cfhttpparam type="formfield" name="form" value="email"> 
    <cfhttpparam type="formfield" name="to" value="#emailTo#"> 
    <cfhttpparam type="formfield" name="mailText" value="#mailText#">
...
<p>
#qGetBrokerDetails.BrokerageName#<br>
#qGetUserDetails.firstname# #qGetUserDetails.lastname#,<br>
</p>
<p>
We are pleased to inform you that your video for <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode# </strong> with the #qTours.tourTypeN# package is online and available for viewing by clicking the link below:
</p>
<p>
BRANDED TOUR LINK:<br/>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#<br/>
...
<p>
You can also download the video in <strong>high or medium</strong> resolution by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the desired resolution</strong> and <strong>click for an immediate .mov video file download</strong> (scroll to bottom of page, past the photos).
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    <cfhttpparam type="formfield" name="tourId" value="#arguments.tourid#">
    <cfhttpparam type="formfield" name="type" value="video finalized"> 
    <cfhttpparam type="formfield" name="level" value="broker"> 
    <cfhttpparam type="formfield" name="form" value="email"> 
    <cfhttpparam type="formfield" name="to" value="#emailTo#"> 
    <cfhttpparam type="formfield" name="mailText" value="#mailText#">
    <cfhttpparam type="formfield" name="subject" value="Spotlight Tour Video is ready! #qTours.address#">
</cfhttp>
                </CFCASE>
...
<p>	
Your tour has been updated for #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with the #qTours.tourTypeN# package and is online and available for viewing by clicking the link below:
</p>
<p>
...
<p>
[ Low 640x480 ] http://www.spotlighthometours.com/download-low.php?id=#qTours.tourid#<br/>
[ Medium 800x600 ] http://www.spotlighthometours.com/download-med.php?id=#qTours.tourid#<br/>
[ High 1800x1200 ] http://www.spotlighthometours.com/download-1800.php?id=#qTours.tourid#<br/><br/>
[ Ultra High 2400x1600 - 4800x3200 ] http://www.spotlighthometours.com/download-high.php?id=#qTours.tourid#
</p>
<div id='subtext'>
<p>
Please feel free to contact us with any questions or problems with your tour.
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    <cfhttpparam type="formfield" name="tourId" value="#arguments.tourid#">
    <cfhttpparam type="formfield" name="type" value="tour updated"> 
    <cfhttpparam type="formfield" name="level" value="broker"> 
    <cfhttpparam type="formfield" name="form" value="email"> 
    <cfhttpparam type="formfield" name="to" value="#emailTo#"> 
    <cfhttpparam type="formfield" name="mailText" value="#mailText#">
    <cfhttpparam type="formfield" name="subject" value="Spotlight Tour has been updated! #qTours.address#">
</cfhttp>
...
questions? call us at 801.466.4074
            ...
            <CFCASE value="reshoot finalized">
                <cfset mailAttributes = {
                    ...
                    from="info@spotlighthometours.com",
                    to="#emailTo#",
                    subject="Spotlight Tour Photos Updated! #qTours.address#"
                }/>
                <cfmail port="465" useSSL="true" useTLS="true" attributeCollection="#mailAttributes#">
Your updated photos for Tour Address: #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with Tour Type: #qTours.tourTypeN#. are now available
go to your Spotlight account to view
questions? call us at 801.466.4074
                </cfmail>       
            </CFCASE>
...
<p>
We are pleased to inform you that your virtual tour for <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#</strong>  with #qTours.tourTypeN# package is online and available for viewing by clicking the link below*:
</p>
<p>
BRANDED TOUR LINK:<br/>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#<br/>
...
<p>
If you also ordered a cinematic package with these photos you will receive a second email confirmation when the video is available for viewing. You can also download the <strong>high, medium, or low resolution</strong> images by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the tour as a whole or individual photos for download.</strong>
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
<p>
You can also download the <strong>high, medium, or low resolution</strong> of your updated images by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the tour as a whole or individual photos for download.</strong>
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
questions? call us at 801.466.4074
            ...
            <CFCASE value="reshoot finalized">
                ...
                <cfmail port="465" useSSL="true" useTLS="true" attributeCollection="#mailAttributes#">
Your updated tour photos for Tour Address: #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with Tour Type: #qTours.tourTypeN#. are available
go to your Spotlight account to view
questions? call us at 801.466.4074
                </cfmail>  
            </CFCASE>
        ...
        <CFSWITCH expression="#arguments.notifyString#">
            ...
            <CFCASE value="scheduled">
                <cfsavecontent variable="mailText">
                    <cfoutput>
<p>
Hello photographer: #qGetAffiliateDetails.fullName# <br>
Tour agent: #qGetUserDetails.firstname# #qGetUserDetails.lastname#<br>
</p>
<p>
Thank you for making an appointment with us.  You are confirmed for the appointment(s) listed below. 
</p>
...
<p>					
Photo Shoot Appointment <cfif #qGetTourDetails.ReScheduledDiff# neq 0>(Re Shoot)</cfif><br>
Date:  <cfif #qGetTourDetails.ReScheduledDiff# neq 0>#qGetTourDetails.ReScheduledDate#<cfelse>#qGetTourDetails.ScheduledDate#</cfif><br>
Time: <cfif #qGetTourDetails.ReScheduledDiff# neq 0>#qGetTourDetails.ReScheduledat#<cfelse>#qGetTourDetails.Scheduledat#</cfif> <br>
Photographer: <cfif #qGetTourDetails.ReScheduledDiff# neq 0>#qGetTourDetails.ReScheduledPhotographer#<cfelse>#qGetTourDetails.ScheduledPhotographer#</cfif><br>
</p>
				<CFIF #qGetTourDetails.isVideoTour# eq 1>
<p>                    
Video Shoot Appointment <cfif #qGetTourDetails.VideoReScheduledDiff# neq 0>(Re Shoot)</cfif><br>
Date:  <cfif #qGetTourDetails.VideoReScheduledDiff# neq 0>#qGetTourDetails.VideoReScheduledDate#<cfelse>#qGetTourDetails.VideoScheduledDate#</cfif><br>
Time: <cfif #qGetTourDetails.VideoReScheduledDiff# neq 0>#qGetTourDetails.VideoReScheduledat#<cfelse>#qGetTourDetails.VideoScheduledat#</cfif> <br>
Video Photographer: <cfif #qGetTourDetails.VideoReScheduledDiff# neq 0>#qGetTourDetails.VideoReScheduledPhotographer#<cfelse>#qGetTourDetails.VideoScheduledPhotographer#</cfif><br>
</p>					</CFIF>
<p>
See attachment below for a Home Photography Checklist. Make sure your property is photo-ready for it's best presentation! Click <a href='http://www.spotlighthometours.com/homeowner_email.php?tourId=#arguments.tourid#'>here</a> to send both the appointment confirmation and the photo-ready checklist to the homeowner or tenant.                    
</p>
...
<cfhttp url="http://spotlighthometours.com/repository_queries/admin_send_notification.php" method="post" result="result" charset="utf-8"> 
    ...
    <cfhttpparam type="formfield" name="subject" value="Spotlight Appointment Confirmation: #qTours.address#">
         ...
         <cfset hashString = generateFetchUserHash(userID=#qUser.userID#) />
                    ...
                    <cfoutput>
<p>
Photographer: #qGetAffiliateDetails.fullName#<br>
Tour Agent: #qGetUserDetails.firstname# #qGetUserDetails.lastname#,<br>
</p>
<p>
We are pleased to inform you that your virtual tour for <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#</strong>  with the #qTours.tourTypeN# package is online and available for viewing by clicking the link below*:
...
<p>
We are pleased to inform you that your updated photos for your virtual tour: <strong>#qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#</strong> are online and available for viewing by clicking the link below*:
</p>
<p>
BRANDED TOUR LINK:<br/>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#<br/>
...
<p>
You can also download the <strong>high, medium, or low resolution</strong> images of your updated photos by following the link below. It will take you directly to the Download Media section of your Spotlight account where you can <strong>choose the tour as a whole or individual photos for download.</strong>
</p>
<p>
http://www.spotlighthometours.com/users/new/autologin.php/?h=#hashString#&tourid=#qTours.tourid#
</p>
...
questions? call us at 801.466.4074
            ...
            <CFCASE value="reshoot finalized">
                ...
                />
                <cfmail port="465" useSSL="true" useTLS="true" attributeCollection="#mailAttributes#">
Your updated tour photos for Tour Address: #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with Tour Type: #qTours.tourTypeN#. are now available
go to your Spotlight account to view
questions? call us at 801.466.4074
				</cfmail>  
         	</CFCASE>
...
<CFQUERY name="userHashExists" datasource="#request.dsn#">
    select hash from user_hash
    where userID = <cfqueryparam cfsqltype="cf_sql_varchar" value="#userID#" />
</CFQUERY>
<CFIF userHashExists.RecordCount gt 0>
<cfset existingUserHash = #userHashExists.hash# />
<cfreturn existingUserHash/>
</CFIF>
