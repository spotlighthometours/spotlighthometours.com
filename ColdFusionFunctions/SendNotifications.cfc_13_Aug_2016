...
<p>
We are pleased to inform you that your virtual tour for #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with the #qTours.tourTypeN# package is online and available for viewing by clicking the link below:
</p>
<p>
...
<p>
We will attempt to link your tour to the MLS <strong><font color="FF0000">if your local MLS allows it</font></strong>, but your MLS number must be put into your Spotlight account. If you did not have an MLS number when the tour was ordered, you can login to your Spotlight account to update this information and we will receive an automatic notification of the change.
</p>
<div id='subtext'>
<p>
...
<p>
We are pleased to inform you that your video for #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with the #qTours.tourTypeN# package is online and available for viewing by clicking the link below:
</p>
<p>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#
</p>
...
<p>
We are pleased to inform you that your virtual tour for #qTours.address# #qTours.city#, #qTours.state# #qTours.zipCode#  with #qTours.tourTypeN# package is online and available for viewing by clicking the link below:
</p>
<p>
http://www.spotlighthometours.com/tours/tour.cfm?tourid=#qTours.tourid#
</p>
