...
?>
    ...
    <div class="the-team">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/phil-lloyd.jpg" width="184" height="184" alt="Phil Lloyd - Controller" /></div>
            <div class="name">Phil Lloyd</div>
            <div class="lbl">Controller</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/amy-hunter.jpg" width="184" height="184" alt="Amy Hunter - Editing" /></div>
            <div class="name">Amy Hunter</div>
            <div class="lbl">Photo Production Manager</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/josh-rushton.jpg" width="184" height="184" alt="Josh Rushton - Editing" /></div>
            <div class="name">Josh Rushton</div>
            <div class="lbl">Video Production Manager</div>
        </div>
        <div class="clear"></div>
        <h2>Office</h2>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/jacob-kerr.jpg" width="184" height="184" alt="Jacob Kerr - Web Development" /></div>
            <div class="name">Jacob Kerr</div>
            <div class="lbl">Web Development</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/william.jpg" width="184" height="184" alt="William Merfalen - Web Development" /></div>
            <div class="name">William Merfalen</div>
            <div class="lbl">Web Development</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/alex-linsley.jpg" width="184" height="184" alt="Alex Linsley - Scheduling" /></div>
            <div class="name">Alex Linsley</div>
            <div class="lbl">Scheduling</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/simone.jpg" width="184" height="184" alt="Simone Tilley - Editing" /></div>
            <div class="name">Simone Tilley</div>
            <div class="lbl">Editing</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/jonathon.jpg" width="184" height="184" alt="Jonathon Holmgren - Editing" /></div>
            <div class="name">Jonathon Holmgren</div>
            <div class="lbl">Editing</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/chris.jpg" width="184" height="184" alt="Chris Oakley - Editing" /></div>
            <div class="name">Chris Oakley</div>
            <div class="lbl">Editing</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/teisha-ahlstrom.jpg" width="184" height="184" alt="Teisha Ahlstrom - Editing" /></div>
            <div class="name">Teisha Ahlstrom</div>
            <div class="lbl">Editing</div>
        </div>
        <div class="team-member">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/isil.jpg" width="184" height="184" alt="Isil Hessick - Video Production and Editing" /></div>
            <div class="name">Isil Hessick</div>
            <div class="lbl">Video Production and Editing</div>
        </div>
        <div class="team-member">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/amanda.jpg" width="184" height="184" alt="Amanda Maher - Executive Assistant" /></div>
            <div class="name">Amanda Maher</div>
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/tyler.jpg" width="184" height="184" alt="Tyler Beck - Video Production" /></div>
            <div class="name">Tyler Beck</div>
            <div class="lbl">Video Production</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/heather.jpg" width="184" height="184" alt="Heather Morley - Scheduling" /></div>
            <div class="name">Heather Morley</div>
            <div class="lbl">Tour Coordinator</div>
        </div>
        <div class="clear"></div>
    </div>
...
A human. Being. 
    ...
    <div class="team-bio-popup" id="simone-tilley-bio">
    	<div class="team-bio">
        	<div class="close"></div>
            <div class="photo"><img src="../repository_images/new/about/headshots/lrg/simone.jpg" alt="Lance May" /></div>
            <div class="team-bio-txt">
...
Bio coming soon...
    ...
    <div class="team-bio-popup" id="tyler-beck-bio">
    	<div class="team-bio">
        	<div class="close"></div>
            <div class="photo"><img <?php echo $lrgWidth; ?> src="../repository_images/new/about/headshots/lrg/tyler.jpg" alt="Tyler Beck" /></div>
            <div class="team-bio-txt">
    ...
    <div class="team-bio-popup" id="amanda-maher-bio">
    	<div class="team-bio">
        	<div class="close"></div>
            <div class="photo"><img <?php echo $lrgWidth; ?> src="../repository_images/new/about/headshots/lrg/amanda.jpg" alt="Amanda Maher" /></div>
            <div class="team-bio-txt">
    ...
    <div class="team-bio-popup" id="jacob-kerr-bio">
    	<div class="team-bio">
            ...
            <div class="team-bio-txt">
                ...
                <div class="bio-txt">
                	<h4>Web Development</h4>
                	<p>Jacob has been working in the web design, development and internet marketing field for over tens years. With an extensive background as the lead web design and development engineer at some of Utah's most prestigious web design firms Jacob has has developed a strong set of skills. With Spotlight and Jacob's insatiable hunger for the technological incline Spotlight is consistently improving their online and offline operations. Jacob loves all forms of art whether it's cooking Italian food, designing and developing new concepts, pushing a new market or just simply going for a hike and listening to music he does it all with a smile on his face.</p>
            	</div>
                <div class="email-form">
