...
?>
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/miranda-kimberlin.jpg" width="184" height="184" alt=“Miranda Kimberlin - Editing" /></div>
            <div class="name">Miranda Kimberlin</div>
            <div class="lbl">Editing Manager</div>
        </div>
        <div class="team-member">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/eric-crawford.jpg" width="184" height="184" alt="Eric Crawford - Sales Manager" /></div>
            <div class="name">Eric Crawford</div>
            <div class="lbl">Director of Marketing/Sales</div>
        </div>  
           
        <div class="clear"></div>
        <h2>Corporate Office</h2>
		<div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/amanda-maher.jpg" width="184" height="184" alt="Amanda Maher - Executive Assistant" /></div>
            <div class="name">Amanda Maher</div>
            <div class="lbl">Executive Assistant</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/tyrell-masterson.jpg" width="184" height="184" alt="Tyrell Masterson - Scheduling" /></div>
            <div class="name">Tyrell Masterson</div>
            <div class="lbl">Scheduling</div>
        </div>
        
       
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/female-avatar.jpg" width="184" height="184" alt="Cynthia Westfall - Scheduling" /></div>
            <div class="name">Cynthia Westfall</div>
            <div class="lbl">Scheduling</div>
        </div>
        
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/female-avatar.jpg" width="184" height="184" alt=“Madi Hayes" /></div>
            <div class="name">Madi Hayes</div>
            <div class="lbl">Concierge Marketing Assistant</div>
        </div>
        <div class="team-member">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/steven-miller.jpg" width="184" height="184" alt=“Steven Miller - Editing" /></div>
            <div class="name">Steven Miller</div>
            <div class="lbl">Editing</div>
        </div>
        <div class="team-member">
        ...
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/female-avatar.jpg" width="184" height="184" alt=“Gabi Savchuk - Editing" /></div>
            <div class="name">Gabi Savchuk</div>
            <div class="lbl">Video Production</div>
        </div>
        <div class="team-member">
        	<div class="photo"><img src="../repository_images/new/about/headshots/heather-morley.jpg" width="184" height="184" alt=“Heather Morley - Tour Coordinator” /></div>
