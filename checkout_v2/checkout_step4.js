...
// $('.paymentAddUpdate').accordion(
// 	{
// 		collapsible: true
// 	});

		// $('.paymentAddUpdate').css({height: 0});
$('#toggleAddUpdate').on('click',function()
	{
		$('.paymentAddUpdate').animate({height: "toggle"});
	});
...
function PopulateCheckout() {
	try {
		...
		if($("#usePaySold").is(':checked')){
			params  += "&usePaySold=1";
			$('.payNowDisclaimer').css({display: 'inline-block'});
		}else{
			params  += "&usePaySold=0";
			$('.payNowDisclaimer').css({display: 'none'});
		}
...
function Terms() {
	try {
		var title = "Spotlight Home Tours Terms and Conditions";
		var tandc  = '<div style="height:300px;overflow:auto;padding-right:15px;"><p>The definition of a Spotlight Home Tour will be determined by the specific package ordered. Each package consists of different amounts of video, stills, and panoramic photographs. Each customer shall have the option to choose the specific rooms/scenes/scenery to be videotaped and or photographed through our online order form. Rooms/scenes/scenery can be changed prior to shooting by contacting the videographer and or photographer. Each customer will also have the opportunity to leave the room/scene/scenery decisions up to videographers and or photographers discretion by checking the box on the online order form or contacting the videographer and/or photographer prior to shooting.</p>';
		tandc  += '<p>Once the tour is processed by Spotlight Home Tours, it will be posted on www.spotlighthometours.com. The URL to the tour will be sent to the email address given to Spotlight Home Tours by the purchaser. This URL can be freely used to create a link to/from your own personal website. Each room/scene/scenery ordered will be made into a video, panoramic, and or still photos tour depending on the tour package ordered. Spotlight Home Tours reserves the right to determine which scenes to use that are in the best interest of the agent, homeowner or other property owner. Choices not to show a particular room/scene/scenery will be the sole and absolute choice of Spotlight and/or its affiliated editing department. Spotlight Home Tours will post the tour to the website only upon receiving all required information. Including, but not limited to; asking price, property address, square footage, number of rooms, etc. Spotlight Home Tours will not be responsible for any delays due to missing information.</p>';
		tandc  += '<p>All Spotlight Home Tours will become inactive after the date specified at the time of purchase. The tour may be reactivated at any time upon request. Spotlight Home Tours reserves the right to assess a reactivation fee and/or an annual fee for any tour that is hosted by Spotlight Home Tours beyond the period of one year. All images and media are considered the sole and exclusive property of Spotlight Home Tours. Spotlight Home Tours reserves all rights to the images, media and content. All images and media shall be made available to the client until the property is sold, the listing expires or twelve (12) months pass, whichever occurs first, unless otherwise agreed upon in writing previously. If the photos are being used for nightly rental and/or vacation rental purposes then the client has full licensing of the images for marketing purposes of the specific property with no end date of use.</p>';
		tandc  += '<p>The customer hereby expressly waives any and all claims, demands, costs, and causes of action against Spotlight Home Tours, its agents, contractors, employees and or assigns, for any and all damages, including property and personal injury, for any acts of the videographers and/or photographers at the property designated by the agent, homeowner or other property owner.</p>';
		tandc  += '<p><strong>Payment Terms:</strong> Payment in full is expected at the time of order unless otherwise previously arranged. If company billing invoice is not paid in full within thirty (30) days following submission of the invoice by Spotlight Home Tours, an interest rate of 2.0% per month will be charged on past due balances (24% per annum). The property, including all video, photographs and all other work completed by Spotlight produced for the customer remains the property of Spotlight Home Tours.</p>';
		tandc  += '<p><strong>Refund Policy:</strong> There will be no refunds given for cancellations made after 48 hours of order. Although full credit may be given to the customer to be used at their discretion. Notice of cancellation must be made via e-mail to customerservice@spotlighthometours.com or phone call to 801-466- 4074. If a refund is approved a cancellation acknowledgement will be sent within 3 business days and fees refunded within 10 working days, subject to this Refund Policy.</p>';
		tandc  += '<p>Note that circumstances beyond the control of Spotlight Home Tours may necessitate substitutions, alterations or cancellations of tour types or products. Therefore, Spotlight Home Tours reserves the right to alter or modify the tour types or products if necessary. Any substitutions or alterations will be updated on the Spotlight Home Tours web site as soon as possible. Where Spotlight Home Tours offers a non-tangible irrevocable services we do not issue refunds once the work is begins.</p>';
		tandc  += '<p>In the event of any action at law or inequity between the customer and Spotlight Home Tours to enforce any of the provisions and/or rights hereunder to recover damages for breach hereof, the unsuccessful party to such litigation covenants and agrees to pay to the successful party all costs and expenses, including attorney fees incurred herein by such successful party, and if such successful party shall recover judgment in any such action or proceeding such costs and expenses and attorney fees shall be included in and as part of such judgment. Any and all changes or modifications of the terms and conditions of this agreement must be in writing and executed by both Spotlight Home Tours and customer. The terms of this Agreement shall be governed by the laws and regulations of the State of Utah. The State of Utah shall have exclusive jurisdiction with respect to any and all legal actions that may arise from this Agreement. This Agreement shall be considered to be the only agreement between the parties. All negotiations and oral agreements acceptable to both parties are included herein. The parties agree that all of the provisions hereof are to be considered as covenants and agreements where used in each separate paragraph hereof, and that all of the provisions hereof shall bind and inure to the benefit of the parties hereto, and their respective heirs, legal representative, agents, successors and assigns. Spotlight Home Tours will use reasonable effort to being flexible to film dates with respect to weather. However, it should be anticipated that filming may take place regardless of weather or adverse conditions.</p></div>';
