...
<script src="../repository_inc/jquery-1.7.2.min.js" language="javascript"></script>
<STYLE TYPE="text/css">
<!--
#container {
	height: 100%;
...
<cfif bitand(#session.adminPermissions#, 1)>
    ...
    <cfif bitand(#session.adminPermissions#, 4) gt 0>
        <DIV style="background-color:#ddd;"><A HREF="themes/new/" TARGET="mainFrame">Themes</A></div>
    </cfif>    
    <cfif bitand(#session.adminPermissions#, 4) gt 0>
    ...
    <cfif bitand(#session.adminPermissions#, 16) gt 0>
        <DIV style="background-color:#ddd;"><A HREF="admin_loan_officer.php" TARGET="mainFrame">Loan Officer</A></div>
    </cfif>
</cfif>
