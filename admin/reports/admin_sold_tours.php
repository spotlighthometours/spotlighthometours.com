    ...
    <body>
		...
		<TR>
			...
			<TH HEIGHT="65" VALIGN="top" width="100px">Disposition Status<br />
            	<a href="admin_reports.php?section=soldTours&status='Not Collected','Withdrawn','Collected'">Show All</a><br />
            	<a href="admin_reports.php?section=soldTours&status='Collected'">Show Collected</a><br />
            	<a href="admin_reports.php?section=soldTours&status='Not Collected'">Show Not Collected</a>
            </TH>	        
		</TR>
<?php
...
?>
                    ...
                    <BR />
                    <a href="../admin_invoice.php?id=<?php echo($row['userID']."&tourid_0=".$row['tourID']."&amount=".$row['agent_paySold_total']."&notes=Tour was sold and this is the outstanding Agent Amount.&invoicenum=".$row['tourID']."_PaySold&card=".$row['crardId']);?>">Bill Agent</a>
                </td>
			</tr>
<?php
		}
