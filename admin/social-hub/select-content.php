...
<link rel="stylesheet" type="text/css" href="includes/select-content-sm.css" />
<link rel="stylesheet" type="text/css" href="includes/select-content.css" media="screen  and (min-width: 40.5em)" />
</head>
<body>
<div class="container">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			...
			<button type="button" class="btn btn-primary" onclick="postContent()"><i class="glyphicon glyphicon-ok"></i> Approve Post</button>
		  </div>
		</div>
	  </div>
	</div>
...
<script src='includes/select-content.js'></script>
<script>
