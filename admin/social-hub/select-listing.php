...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="includes/select-listing-sm.css" />
		<link rel="stylesheet" type="text/css" href="includes/select-listing.css" media="screen  and (min-width: 40.5em)" />
	</head>
	<body>
		<div class="container">
		...
		<script src='includes/select-listing.js'></script>
		<script>
