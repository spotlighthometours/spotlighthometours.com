...
<div class="container">
	<div class="row">
		<section>
			<h2 class="setup-title" style="margin-top:10px;"><img src="images/concierge-social-logo3.png" /><?PHP echo ($socialmarketing->isPlatinumMember($_SESSION['user_id']))?'<span class="pull-right"><img src="images/platinum-level.png" style="margin-top:-10px;"></span>':''; ?><br/>Setup <small>0% Complete</small></h2>
			<div class="wizard">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" role="tabpanel" id="step3">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<!-- <p class="lead"><strong>Send proof email?</strong> <input type="checkbox" class="toggle-check" id="proofemail" data-toggle="toggle">&nbsp;<small><a href="#" data-toggle="tooltip" title="Turn this feature on if you would like Spotlight to send you a proof email before sending out any content."> <img src="images/info-bubble.png" alt="info-bubble"></a></small></p>
									
									<p class="lead"><strong>Auto-Post at 8:00 PM Mountain Time?</strong> <input type="checkbox" class="toggle-check" id="forcepost" data-toggle="toggle">&nbsp;<small><a href="#" data-toggle="tooltip" title="Turn this feature on if you would like Spotlight to post the content automatically at 8:00 pm Mountain Time even if you have not approved the proof email."> <img src="images/info-bubble.png" alt="info-bubble"></a></small></p> -->
						...
						<div class="tab-pane" role="tabpanel" id="step6">
							<div class="panel panel-default">
								...
								<p class="lead"><strong>Auto-Post if proof is not selected?</strong> <span class="text-muted">(8:00 PM MST)</span> <input type="checkbox" class="toggle-check" id="forcepost" data-toggle="toggle">&nbsp;<small><a href="#" data-toggle="tooltip" title="Turn this feature on if you would like Spotlight to post the content automatically at 8:00 pm MST even if you have not approved the proof email."> <img src="images/info-bubble.png" alt="info-bubble"></a></small></p>
								<div class="panel-footer clearfix">
									<a class="btn btn-primary prev-step pull-left">Previous</a>
