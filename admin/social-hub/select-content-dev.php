...
<link rel="stylesheet" type="text/css" href="includes/select-content-sm-dev.css" />
<link rel="stylesheet" type="text/css" href="includes/select-content-dev.css" media="screen  and (min-width: 40.5em)" />
</head>
<body>
<div class="container">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="eCatModalLabel">Turn On Networks for this post?</h4>
		  </div>
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Select Post</button>
			<button type="button" class="btn btn-primary" onclick="postContent()">Approve Post</button>
		  </div>
		</div>
	  </div>
	</div>
...
<script src='includes/select-content-dev.js'></script>
<script>
