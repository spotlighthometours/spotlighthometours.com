...
?>
		<tr id="user_<?PHP echo $column['userID'] ?>">
			...
			<td><?PHP echo date('F d, Y', strtotime($column['createDate'])); ?></td>
			<td class="list-button">
				<a href="javascript:window.open('user-credits.php?userID=<?PHP echo $users->userID ?>','User Credits','height=400,width=950');">Credits</a>
			</td>
			<td class="list-button">
<?PHP
	if($column['active']=="0"){
