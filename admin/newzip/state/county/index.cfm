				...
				<CFIF Trim(Evaluate('form.' & i)) neq "">
					...
					<CFELSE>
						<CFQUERY name="qCount" datasource="#request.dsn#">
							select max(pb_id) as mynum from pricing_counties 
						</CFQUERY>
						<CFQUERY name="qInsert" datasource="#request.dsn#">
							insert into pricing_counties (pb_id, state_id,county_id, tourtype_id, unitprice,hide)
							values (
