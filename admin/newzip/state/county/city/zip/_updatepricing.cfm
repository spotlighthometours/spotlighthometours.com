<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from tourTypes tt left join 
			(select unitprice, tourtype_id,broker_billable,hide from pricing_zips where state_id = 
