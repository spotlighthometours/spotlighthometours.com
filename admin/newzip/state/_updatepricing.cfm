<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from tourTypes tt left join 
			(select unitprice, tourtype_id,broker_billable,hide from pricing_states where state_id = 
...
<BODY>
<A HREF="http://www.spotlighthometours.com/admin/newzip/state/index.cfm?pg=editpricing">State</A>
<CFOUTPUT>
