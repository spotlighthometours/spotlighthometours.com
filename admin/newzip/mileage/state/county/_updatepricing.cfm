<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from mileage tt left join 
			(select unitprice, tourtype_id,broker_billable,hide from pricing_counties_mileage where state_id = 
...
<BODY>
<CFOUTPUT>
<A HREF="http://www.spotlighthometours.com/admin/newzip/mileage/state/index.cfm?pg=editpricing">State</A> - <A HREF="/admin/newzip/mileage/state/county/index.cfm?pg=editpricing&stateid=#url.stateid#&state=#url.state#">County</A> <BR>
