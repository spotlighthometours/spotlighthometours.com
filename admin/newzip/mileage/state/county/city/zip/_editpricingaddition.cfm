...
<H3>Default mileage Product Pricing</H3>
...
<H3>Broker Specific mileage Product Pricing</H3>
<TABLE WIDTH="90%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
  ...
  <CFLOOP query="qBrokerages">
	  <TR BGCOLOR="###iif(currentRow mod 2, de("E8EEF7"), de("ffffff"))#">
		...
		<TD><A HREF="#cgi.script_name#?pg=editmileagepricing&id=#qBrokerages.brokerageID#">Edit</A></TD>
	  </TR>
  </CFLOOP>
</TABLE>
</CFOUTPUT>
