...
<CFSWITCH expression="#url.action#">
	...
	<CFCASE value="updatePrice">
		...
		<CFLOOP list="#lFields#" index="i">
			<CFIF FindNoCase('Tour_',i) neq 0>
				...
				<CFQUERY name="qPrevious" datasource="#request.dsn#">
                    ...
                    and zip_id = <cfqueryparam cfsqltype="cf_sql_integer" value="#ListGetAt(form.zipid,2,'_')#" />
					...
					<CFELSE>
						...
						<CFQUERY name="qInsert" datasource="#request.dsn#">
							...
							values (
                                ...
                                <cfqueryparam cfsqltype="cf_sql_integer" value="#ListGetAt(form.zipID,2,'_')#" />,
        ...
        <CFSET url.zipid = ListGetAt(form.zipid,2,'_') />
