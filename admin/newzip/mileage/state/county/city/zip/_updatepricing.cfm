<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from mileage tt left join 
			(select unitprice, tourtype_id,broker_billable,hide from pricing_zips_mileage where state_id = 
