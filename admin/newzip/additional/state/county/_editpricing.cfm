...
<BODY>
<CFOUTPUT>
<A HREF="http://www.spotlighthometours.com/admin/newzip/additional/state/index.cfm?pg=editpricing">State</A> - County <BR>
...
<TABLE WIDTH="90%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <CFLOOP query="qBrokerages">
	  <TR BGCOLOR="###iif(currentRow mod 2, de("E8EEF7"), de("ffffff"))#">
		...
		<TD><A HREF="#cgi.script_name#?pg=updatePrices&countyid=#qBrokerages.zip_code_state_id#&stateid=#url.stateid#&state=#url.state#">Edit</A> - <A HREF="/admin/newzip/additional/state/county/city/index.cfm?pg=editpricing&stateid=#url.stateid#&countyid=#qBrokerages.zip_code_state_id#&county=#qBrokerages.county#&state=#url.state#&">city</A></TD>
	  </TR>
  </CFLOOP>
</TABLE>
</CFOUTPUT>
