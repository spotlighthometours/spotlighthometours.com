...
<TABLE WIDTH="90%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
  ...
  <CFLOOP query="qBrokerages">
	  <TR BGCOLOR="###iif(currentRow mod 2, de("E8EEF7"), de("ffffff"))#">
		...
		<TD><A HREF="#cgi.script_name#?pg=updatePrices&id=#qBrokerages.zip_code_state_id#">Edit</A> - <A HREF="/admin/newzip/additional/state/county/index.cfm?pg=editpricing&stateid=#qBrokerages.zip_code_state_id#&state=#qBrokerages.state#">County</A></TD>
	  </TR>
  </CFLOOP>
</TABLE>
</CFOUTPUT>
