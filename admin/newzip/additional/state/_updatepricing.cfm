<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from  products tt  left join 
			(select unitprice, tourtype_id,broker_billable,hide from pricing_states_additional where state_id = 
...
<BODY>
<A HREF="http://www.spotlighthometours.com/admin/newzip/additional/state/index.cfm?pg=editpricing">State</A>
<CFOUTPUT>
