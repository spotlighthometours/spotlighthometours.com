...
$blackListedBr = $products->getBlacklistedBr();

// Get brokerage pricing
$brokeragePricing = $products->getBrokeragePricing();
...
<script>
	...
	function addSelection(id){
		...
		var url = "../repository_queries/admin_products_updatebrokerages.php?"+query;
		params = "";
	...
	function selectAll(){
		...
		if(proceed){
			...
			alert('Adding all Brokerages to this product!');
		}
	}
	...
	function deselectAll(){
		...
		if(proceed){
			...
			alert('Removing all Brokerages from this product!');
		}
	}
	...
	function updatePrice(element){
		...
		if(element.value==""){
			query = "action=remove&id="+<?PHP echo $_GET['id']; ?>+"&brokerageID="+id;
			var url = "../repository_queries/admin_products_updatebrokeragepricing.php?"+query;
			params = "";
			ajaxQuery(url, params, 'nothing');
		}else{
