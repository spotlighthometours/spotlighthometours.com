<cfsilent>
	...
	<cfquery name="qAgents" datasource="#request.dsn#">
		select u.userid, u.firstname, u.lastname, b.brokerageName, case when isnull(m.active) then 0 else m.active end as PreviewActive
...
<table width="90%" border="0" cellspacing="2" cellpadding="2">
	...
	<cfloop query="qAgents">
		<tr bgcolor="###iif(qAgents.CurrentRow mod 2, de("E8EEF7"), de("ffffff"))#">
			...
			<td><input type="checkbox" name="agent_#qAgents.userid#" <cfif qAgents.PreviewActive eq 1>checked</cfif> /></td>
		</tr>
	</cfloop>
