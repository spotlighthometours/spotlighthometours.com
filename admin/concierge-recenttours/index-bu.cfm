    ...
    <TR>
    	...
    	<TD COLSPAN="4">
		    <DIV ALIGN="right">
				...
				<cfif range neq 1>
				    <CFIF url.start gt 0>
		                <A HREF="../concierge-recenttours/?start=#Evaluate(url.start - url.rows)#&rows=#url.rows#">Previous Page</A>
				    </CFIF>
				    <CFIF qTours.RecordCount eq url.rows>
			            <A HREF="../concierge-recenttours/?start=#Evaluate(url.start + url.rows)#&rows=#url.rows#">Next Page</A>
				    </CFIF>
				</cfif>
			</DIV>
		</TD>
