...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
    <TR>
	    <TD HEIGHT="65" COLSPAN="17" VALIGN="top"><A HREF="../concierge-recenttours/proc_media.cfm?initiate=true" onClick="return confirmProcess();"></A>
    	...
    	<TD COLSPAN="4">
		    <DIV ALIGN="right">
				...
				<cfif range neq 1>
				    <CFIF url.start gt 0>
		                <A HREF="../concierge-recenttours/list.cfm?start=#Evaluate(url.start - url.rows)#&rows=#url.rows#">Previous Page</A>
				    </CFIF>
				    <CFIF qTours.RecordCount eq url.rows>
			            <A HREF="../concierge-recenttours/list.cfm?start=#Evaluate(url.start + url.rows)#&rows=#url.rows#">Next Page</A>
				    </CFIF>
				</cfif>
			</DIV>
		</TD>
