...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
    <TR>
    	...
    	<TD COLSPAN="4">
		    <DIV ALIGN="right">
				<select onChange="window.location='?startdate=#url.startdate#&enddate=#url.enddate#&orderby=#url.orderby#&progorderby=#url.progorderby#&rows='+this.value">
	...
	<tr>
  	...
  	<TR style="white-space:nowrap; text-align:center">
  	    <TH valign="bottom" WIDTH="4%"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=tours.tourid<cfif url.orderby eq "tours.tourid">%20desc</cfif>">TourID</A></TH>
  		<TH valign="bottom" WIDTH="19%"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=tours.address<cfif url.orderby eq "tours.address">%20desc</cfif>">Address</A></TH>
  		...
  		<TH valign="bottom" WIDTH="5%"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=orders.createdOn<cfif url.orderby eq "orders.createdOn">%20desc</cfif>">Created</A></TH>
		<TH valign="bottom" WIDTH="5%"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.Scheduledon<cfif url.progorderby eq "tp.Scheduledon">%20desc</cfif>">Scheduled<BR>On</A></TH>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.ScheduleAttempted<cfif url.progorderby neq "tp.ScheduleAttempted%20desc">%20desc</cfif>"><SPAN CLASS="style1">Schedule<BR>Attempt </SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.Scheduled<cfif url.progorderby neq "tp.Scheduled desc">%20desc</cfif>"><SPAN CLASS="style1">Scheduled</SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.MediaReceived<cfif url.progorderby neq "tp.MediaReceived desc">%20desc</cfif>"><SPAN CLASS="style1">Photo<BR>Media<BR>Received</SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tourCategory<cfif url.progorderby neq "tourCategory desc, tp.VideoMediaReceived desc">%20desc</cfif>, tp.VideoMediaReceived<cfif url.progorderby neq "tourCategory desc, tp.VideoMediaReceived desc">%20desc</cfif>"><SPAN CLASS="style1">Video<BR>Media<BR>Received</SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.Edited<cfif url.progorderby neq "tp.Edited desc">%20desc</cfif>"><SPAN CLASS="style1">Photo<BR>Edited</SPAN></A></TD>
		...
		<!---<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.TourBuilt<cfif url.progorderby neq "tp.TourBuilt desc">%20desc</cfif>"><SPAN CLASS="style1">Tour Built </SPAN></A></TD>--->
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.Realtorcom<cfif url.progorderby neq "tp.Realtorcom desc">%20desc</cfif>"><SPAN CLASS="style1">Realtor<BR>.com </SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.mls<cfif url.progorderby neq "tp.mls desc">%20desc</cfif>"><SPAN CLASS="style1">MLS</SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.finalized<cfif url.progorderby neq "tp.finalized desc">%20desc</cfif>"><SPAN CLASS="style1">Photo<BR>Tour<BR>Finalized </SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tourCategory<cfif url.progorderby neq "tourCategory desc, tp.VideoFinalized desc">%20desc</cfif>, tp.VideoFinalized<cfif url.progorderby neq "tourCategory desc, tp.VideoFinalized desc">%20desc</cfif>"><SPAN CLASS="style1">Video<BR>Tour<BR>Finalized </SPAN></A></TD>
		<TD valign="bottom" WIDTH="4%" BGCOLOR="##C3D9FF"><A HREF="#cgi.script_name#?startdate=#url.startdate#&enddate=#url.enddate#&rows=#url.rows#&orderby=#url.orderby#&progorderby=tp.follow_up<cfif url.progorderby neq "tp.follow_up desc">%20desc</cfif>"><SPAN CLASS="style1">Followed<BR>Up </SPAN></A></TD>
        <TH WIDTH="6%"></TH>
  		<TH WIDTH="4%"></TH>
