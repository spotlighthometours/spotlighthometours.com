...
<form action="#cgi.sript_name#?action=<cfif editMode>updateUser<cfelse>insertUser</cfif>" method="post">
    <table width="800" border="0" cellspacing="2" cellpadding="4">
          ...
          <td class="rowData">
          	<cfif (editMode) AND (mlsIDResults.RecordCount gt 0)>
                ...
                <cfloop query="mlsIDs">
                    ...
                    <input name="mls" type="text" size="30" maxlength="30" value="#mlsIDs.mlsID#"> &nbsp;MLS Provider: 
      ...
      <tr>
        <td class="rowHead">Other MLS Provider</td>
        <td class="rowData"><input name="otherMLSProvider" type="text" size="32" maxlength="50"<cfif editMode> value="#qUsers.otherMLSProvider#"</cfif>></td>
      </tr>
      <tr>
...
<!---      <tr>
      ...
      <tr>
        ...
        <td class="rowData"><input type="text" name="phone" <cfif editMode> value="#qUsers.phone#"</cfif> /></td>
      </tr>
		<tr>
...
--->
        ...
        <tr>
          <td class="rowHead">Listing BG Video</td>
          <td class="rowData">
			[ <span style="text-decoration:underline;cursor:pointer;" onClick="window.open('../media-manager/index.php?parentType=mylstbg&parentID=#url.user#','name','height=500,width=1000')">MANAGE UPLOADS</span> ]
		</td>
        </tr>
      </cfif>
      <tr>
