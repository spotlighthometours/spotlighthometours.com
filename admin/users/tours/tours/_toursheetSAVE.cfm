...
<CFQUERY name="qTours" datasource="#request.db.dsn#">
	select t.*,
    date_format(createdOn,'%m/%d/%Y - %h:%i:%s %p') as dateord, tt.tourCategory,
...
<cfif #qTours.tourCategory# neq "Video Tours">
	<CFSET videoTour = true>
</cfif>
...
<style>
	...
	/* <![CDATA[ */
		...
		function cancelSchedule(video){
			...
			//$('input:radio[name=check]:nth(1)').click();
			//$("#toursheet").append('<input type="hidden" name="save" value="Save"/>');
			//$("#save").click();
			
			SaveSubmit(0, cancelType);
		}
		
		function SaveSubmit(doSubmit, cancelType) {
...
<a href="javascript:window.open('http://www.spotlighthometours.com/admin/admin_create_youtube.php?tourID=#url.tour#','','width=800,height=400')"><strong>CONVERT A SLIDESHOW TO YOUTUBE VIDEO</strong></a>
</div>
...
<TABLE WIDTH="840" BORDER="0" CELLSPACING="0" CELLPADDING="0">
  ...
  <TR>
    ...
    <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
      ...
      <TR>
        <TD><INPUT type="checkbox" NAME="CopyPhotoInfo" ID="CopyPhotoInfo" onClick="CopyPicToVideoPhotographer(this)" value=1 <cfif #qTours.tourCategory# neq "Video Tours">disabled<cfelseif qTourPro.CopyPhotoInfo eq 1>checked</cfif>>Copy photographer information to Video Schedule</TD>
        <TD>&nbsp;</TD>
      </TR>
      <TR>
        <TD width="50%">
            	...
            	<tr>
         		...
         		<tr>
                    <td>Photos Edited By: 
                        ...
                        <br><span style="font-size:11px;">[ <a href="/admin/photographer-feedback.php?tourID=#url.tour#&video=0" target="_blank">photographer feedback</a> ]</span>
                   </td>
                </tr>
                <tr>
                   <td>
            	...
            	<tr>
         		...
         		<tr>
                    <td>Video Edited By: 
                        ...
                        <BR><span style="font-size:11px;">[ <cfif #qTours.tourCategory# eq "Video Tours"><a href="/admin/photographer-feedback.php?tourID=#url.tour#&video=1" target="_blank">video photographer feedback</a><cfelse>video photographer feedback</cfif> ]</span>
                   	</td>
                </tr>
                <tr>
                    <td>
