<CFSILENT>
	...
	<CFQUERY name="qTourTypes" datasource="#request.db.dsn#">
		...
		from products tt left join 
			(select unitprice, product_id,broker_billable,hide from pricing_brokers_additional where brokerage_id = 
...
<FORM ACTION="#cgi.script_name#?action=updateadditionalPrice" METHOD="post">
