...
<CFSWITCH expression="#url.action#">
	...
	<CFCASE value="updateBrokerage">
		...
		<CFIF form.delete_logo eq "1">
            <CFSET filepath = expandPath("../../images/logos")>
            <CFQUERY datasource="#request.dsn#">
				UPDATE brokerages SET logo = '' WHERE brokerageID = '#form.brokerageID#'
			</CFQUERY>
            <cfif FileExists("#filepath#/#form.old_logo#")>
               <cffile action="delete" file="#filepath#/#form.old_logo#">
            </cfif>
			<CFSET msg = "The brokerage was successfully updated and the brokerage logo has been deleted.">
        </CFIF>
