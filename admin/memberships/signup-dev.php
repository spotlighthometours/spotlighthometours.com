		...
		<form id="membershipsForm">
		  <fieldset>
			...
			<ul class="list-group totals">
				...
				Free trial? <small>Start charging them in 30 days?</small>
				<span class="badge badge-default badge-pill numb-memb"><input type="checkbox" id="freeTrial" class="form-check-input" style="margin:0px;"></span>
			  </li>
			  <li class="list-group-item justify-content-between">
				Memberships
